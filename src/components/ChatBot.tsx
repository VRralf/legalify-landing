...
const ChatBot: React.FC<Props> = () => {
  ...
  const getMessage = () => {
    ...
    return "Bienvenido a Legalify! Si necesitas información acerca del funcionamiento de nuestra plataforma o ayuda con el registro puedes contactarte con nuestros asesores por WhatsApp haciendo click aquí";
  };
